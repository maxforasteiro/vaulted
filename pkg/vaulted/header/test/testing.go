...
func (m *MockHeaderService) Serialize(header *header.Header) ([]byte, error) {
...
func (m *MockHeaderService) Deserialize(content string) (*header.Header, error) {
	...
	return returnValue.(*header.Header), err
}
